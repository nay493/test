...
void the_file_comp_help(void)
{
	printf("file_comp store 1 filename.txt\n");
	printf("file_comp retrive 2 filename\n");
	printf("file_comp help 3 for supported features\n");
	printf("file_comp close 4 file_comp\n");
}
